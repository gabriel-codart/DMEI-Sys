...
export default function Substitutions() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://10.10.136.100:3002/api/substitutions/page=${(page-1)}/perPage=${perPage}/search=${search}`,)
        .then((res) => {
            setSubstitutionsList(res.data);
        });

        axios.get('http://10.10.136.100:3002/api/substitutions/')
        .then((res) => {
    ...
    const deleteSubstitution = (cod) => {
        ...
        axios.delete(`http://10.10.136.100:3002/api/substitutions/${id}/${year}/delete`)
        .then((res) => {
