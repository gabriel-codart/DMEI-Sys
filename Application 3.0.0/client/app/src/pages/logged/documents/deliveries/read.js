...
export default function Deliveries() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://10.10.136.100:3002/api/deliveries/page=${(page-1)}/perPage=${perPage}/search=${search}`,)
        .then((res) => {
            setDeliveriesList(res.data);
        });

        axios.get('http://10.10.136.100:3002/api/deliveries/')
        .then((res) => {
    ...
    const deleteDelivery = (cod) => {
        ...
        axios.delete(`http://10.10.136.100:3002/api/deliveries/${id}/${year}/delete`)
        .then((res) => {
